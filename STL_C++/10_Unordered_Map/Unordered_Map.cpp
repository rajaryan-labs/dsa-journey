 ...
 *
 * An Unordered Map is an associative container that stores elements in
 * Key-Value pairs. Unlike std::map, elements are NOT sorted. They are organized
 * using HASH TABLES.
 *
 * Key Features:
 * - Unsorted: Order of elements is undefined (random-looking).
 * - Unique Keys: No duplicate keys allowed.
 * - Complexity: Insert, Delete, Search are O(1) on average (O(N) in rare worst
 * case).
